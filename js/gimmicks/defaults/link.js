(function($) {
    var lnkGimmick = new MDwiki.Gimmick.Gimmick('defaultlnk');
    var lnkHandler = new MDwiki.Gimmick.GimmickHandler('link');
    lnkHandler.loadStage = 'pregimmick';

    lnkHandler.callback = function (params, done) {
    ...
    lnkGimmick.addHandler(lnkHandler);
    $.md.wiki.gimmicks.registerGimmick(lnkGimmick);
}(jQuery));